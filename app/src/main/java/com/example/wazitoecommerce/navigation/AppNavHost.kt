...
import com.example.wazitoecommerce.ui.theme.screens.details.SplashScreen
...
import com.example.wazitoecommerce.ui.theme.screens.seeds.SeedsScreen
import com.example.wazitoecommerce.ui.theme.screens.signup.SignupScreen
import com.example.wazitoecommerce.ui.theme.screens.tips.TipsScreen
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(SEEDS_URL){
            SeedsScreen(navController = navController)
        }
